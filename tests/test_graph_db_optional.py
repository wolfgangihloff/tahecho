...
class TestGraphDBManager:
    ...
    def test_graph_db_manager_import_without_py2neo(self):
        ...
        try:
            ...
            if "py2neo" in str(e):
                pytest.skip(
                    "py2neo not installed - this is expected in some environments"
                )
            else:
                raise
    ...
    def test_graph_db_manager_initialization(self):
        ...
        try:
            from tahecho.utils.graph_db import GraphDBManager
    ...
    def test_graph_db_disabled_in_config(self):
        ...
        try:
            ...
            with patch("tahecho.utils.graph_db.CONFIG") as mock_config:
    ...
    def test_graph_db_connection_failure_handling(self):
        ...
        try:
            ...
            with patch("tahecho.utils.graph_db.CONFIG") as mock_config:
                ...
                with patch("tahecho.utils.graph_db.Graph") as mock_graph:
    ...
    def test_graph_db_successful_connection(self):
        ...
        try:
            ...
            with patch("tahecho.utils.graph_db.CONFIG") as mock_config:
                ...
                with patch("tahecho.utils.graph_db.Graph") as mock_graph_class:
    ...
    def test_graph_agent_adapts_to_no_graph_db(self):
        ...
        try:
            ...
            with patch("agents.langchain_graph_agent.graph_db_manager") as mock_manager:
                ...
                assert (
                    "graph database"
                    in result_state.agent_results["graph_agent"].lower()
                )
