...
class TestWorkflowExecution:
    ...
    def test_basic_jira_query_workflow(self):
        ...
        try:
            ...
            result = langchain_manager_agent.run(
                query, conversation_id="test_conversation"
            )
    ...
    def test_workflow_with_graph_db_disabled(self):
        ...
        try:
            ...
            with patch("tahecho.utils.graph_db.graph_db_manager") as mock_manager:
...
class TestLangGraphWorkflow:
    ...
    def test_workflow_execution_flow(self):
        ...
        try:
            ...
            result = langgraph_workflow.execute(
                "Test query", conversation_id="test_conv"
            )
    ...
    def test_mcp_agent_execution(self):
        ...
        try:
            ...
            state = create_initial_state(
                "Show me my Jira issues", conversation_id="test_conv"
            )
            ...
            print(
                f"✅ MCP agent result: {result_state.agent_results['mcp_agent'][:100]}..."
            )
...
class TestIntegrationScenarios:
    ...
    def test_conversation_persistence(self):
        ...
        try:
            ...
            # First query
            result1 = langchain_manager_agent.run(
                "First message", conversation_id=conversation_id
            )

            # Second query
            result2 = langchain_manager_agent.run(
                "Second message", conversation_id=conversation_id
            )
    ...
    def test_error_recovery(self):
        ...
        try:
            ...
            result = langchain_manager_agent.run(
                query, conversation_id="test_error_recovery"
            )
