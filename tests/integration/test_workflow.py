...
class TestLangGraphWorkflow:
    ...
    def test_workflow_mcp_execution(self, mock_mcp_agent, mock_classifier, mock_memory, mock_chat_openai):
        ...
        mock_classifier_instance.classify_task.return_value = create_initial_state("test")
        ...
        mock_mcp_instance.execute.return_value.agent_results = {"mcp_agent": "MCP result"}
    ...
    def test_workflow_graph_execution(self, mock_graph_agent, mock_classifier, mock_memory, mock_chat_openai):
        ...
        mock_graph_instance.execute.return_value.agent_results = {"graph_agent": "Graph result"}
    ...
    @patch('agents.langgraph_workflow.MemorySaver')
    @patch('agents.task_classifier.task_classifier')
    def test_workflow_general_execution(self, mock_classifier, mock_memory, mock_chat_openai):
