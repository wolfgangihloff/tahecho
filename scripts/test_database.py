...
async def test_database_operations():
    ...
    try:
        ...
        test_document = {
            ...
            "metadata": {"test_type": "rls_verification", "created_by": "test_script"},
        ...
        retrieved_doc = await supabase.get_document_by_url(
            "https://test.example.com/rls-test"
        )
        if retrieved_doc:
        ...
        similar_docs = await supabase.search_similar_documents(
            query_embedding=mock_embedding, source_types=["test"], limit=5
        )
