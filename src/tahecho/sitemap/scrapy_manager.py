...
class ScrapyManager:
    ...
    def __init__(self, config_manager: ConfigurationManager):
        ...
        self.embedding_generator = EmbeddingGenerator(config_manager.get_embedding_config())
        self.operations: Dict[str, Dict[str, Any]] = {}
    
    async def scrape_sitemap(self, url: str, incremental: bool = False, 
                           differential: bool = False, config: Dict[str, Any] = None) -> str:
    ...
    async def update_sitemap(self, url: str, incremental: bool = True, 
                           differential: bool = False, config: Dict[str, Any] = None) -> str:
    ...
    async def _run_scraping_operation(self, operation_id: str):
        ...
        try:
            logger.info(f"Starting scraping operation {operation_id} for {operation['url']}")
    ...
    async def _run_update_operation(self, operation_id: str):
        ...
        try:
            logger.info(f"Starting update operation {operation_id} for {operation['url']}")
    ...
    async def _run_incremental_update(self, operation_id: str, existing_sitemap: Dict[str, Any]):
    ...
    async def _run_differential_update(self, operation_id: str, existing_sitemap: Dict[str, Any]):
        ...
        await self._simulate_differential_update(operation_id, existing_sitemap['id'], differential_sections)
    ...
    async def _simulate_differential_update(self, operation_id: str, sitemap_id: str, sections: List[str]):
