        ...
        try:
            ...
            for issue in issues["issues"]:
                ...
                filtered_issue = {
                    ...
                    "status": (
                        {
                            ...
                            "statusCategory": {
                                "name": issue["fields"]["status"]["statusCategory"].get(
                                    "name"
                                )
                            },
                        }
                    ...
                    "issuetype": (
                        {
                            ...
                            "description": issue["fields"]["issuetype"].get(
                                "description"
                            ),
                        }
                    ...
                    "reporter": (
                        {
                            "displayName": issue["fields"]["reporter"].get(
                                "displayName"
                            ),
                            "emailAddress": issue["fields"]["reporter"].get(
                                "emailAddress"
                            ),
                        }
